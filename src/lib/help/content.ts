...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    body: 'Start here. One tap opens today\u2019s check-in — mood, energy, sleep and more in under 10 seconds.',
  },
  {
    route: '/',
    selector: 'cycle-hero',
    title: 'Today at a glance',
    body: 'Your cycle day, current phase and when your next period is expected, all in one card.',
  },
  {
    route: '/',
    selector: 'mini-calendar',
    title: 'This month\u2019s preview',
    body: 'A colour-coded look at the current month. Tap "Full calendar" to jump straight there.',
  },
  {
    route: '/',
    selector: 'home-grid',
    title: 'Notes & reminders',
    body: 'Your latest journal note and the next upcoming reminder live side by side.',
  },
  {
    route: '/',
    selector: 'fab',
    title: 'Quick add',
    body: 'The plus button opens today\u2019s check-in from anywhere on the home screen.',
  },
  {
    route: '/calendar',
    selector: null,
    title: 'Your calendar',
    body: 'The heart of Luvina. Each day is colour-coded by your cycle — tap any day to log or review it.',
  },
  {
    route: '/calendar',
    selector: 'month-grid',
    title: 'Tap a day',
    body: 'Tap any date to open its check-in sheet. Long-press or right-click for the same quick action.',
  },
  {
    route: '/calendar',
    selector: 'calendar-legend',
    title: 'Read the legend',
    body: 'Periods, predictions, ovulation, fertile days, logged symptoms, notes, today and your selection — all explained here.',
  },
  {
    route: '/history',
    selector: null,
    title: 'Your cycle history',
    body: 'Every logged cycle becomes a timeline you can review and edit. Your story, month by month.',
  },
  {
    route: '/insights',
    selector: null,
    title: 'Insights',
    body: 'Averages, consistency and prediction accuracy, calculated locally from your logged cycles.',
  },
  {
    route: '/insights',
    selector: 'insights-charts',
    title: 'Spot the trends',
    body: 'Charts show how your cycle length and period days change over time.',
  },
  {
    route: '/settings',
    selector: 'settings-profile',
    title: 'Personalize',
    body: 'Your name, appearance, animation intensity and haptics — Luvina feels like yours.',
  },
  {
    route: '/settings',
    selector: 'settings-notifications',
    title: 'Notifications',
    body: 'Gentle reminders for your period, ovulation, medication and daily check-ins.',
  },
  {
    route: '/settings',
    selector: 'settings-backup',
    title: 'Backup & export',
    body: 'Encrypted backups you control. Export, restore, or wipe — your data, your rules.',
  },
  {
    route: '/settings',
    selector: 'settings-help',
    title: 'Help & Discover',
    body: 'Your knowledge hub: guides, FAQs, tips, release notes and support — everything about Luvina.',
  },
  {
    route: '/settings',
    selector: 'settings-data',
    title: 'Data & privacy',
    body: 'Erase everything anytime, load sample data, and review how your information is handled.',
  },
]
...
export const FAQS: FaqEntry[] = [
  ...
  {
    id: 'faq-ai-insights',
    question: 'Are AI insights computed in the cloud?',
    answer:
      'No. Every insight, average and chart is computed locally on your device. Nothing is uploaded for analysis.',
    keywords: ['ai', 'insights', 'cloud', 'local', 'privacy'],
  },
  {
